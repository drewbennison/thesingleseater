...
source("C:/Users/drewb/Desktop/Projects/thesingleseater/scripts/production/thesingleseater_theme.R")
...
sectors<-c("SF to I1","I1 to I2", "I2 to I3", "I3 to I4", "I4 to I5","I5 to I6", "I6 to I7", "I7 to I8", "I8 to I9", "I9 to I10", "I10 to I11", "I11 to I12", "I12 to I13", "I13 to I14", "I14 to I15", "I15 to I16", "I16 to SF", "Full Lap")
...
plot<-ggplot(data=data, aes(x=Section, y=reorder(Driver, -Car))) + 
  ...
  labs(fill = "% Faster\nThan Average\nSector Speed", title="2021 Nashville GP Practice 2",
...
ggsave("C:/Users/drewb/Desktop/plot2.png", height = 8, width = 10.5)
...
for (i in sectors) {
  d <- data %>%
    filter(Section==i) %>% 
    top_n(1, Speed)
  message(paste0(d[,4]," was quickest through ",d[,1], " and was ", round(d[,10],2), "% faster than the average car."))
}
...
data <- data %>% filter(!is.na(percRelativeSection))
