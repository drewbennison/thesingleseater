thesingleseater_theme <- function(base_size = 20, base_family = "",
  ...
  theme(
    ...
    axis.title.x =       element_text(
      ...
      vjust = 1,
      color = rgb(59, 59, 59, maxColorValue = 255),
      size = rel(.85)
    ),
    ...
    legend.text =        element_text(size = rel(0.7),
                         color = rgb(87, 87, 87, maxColorValue = 255)          
    ),
    ...
    panel.grid.major = element_line(
      rgb(153, 148, 148, maxColorValue = 255),
      rel(.5),
      linetype = "dotted"),
    panel.grid.minor = element_line(
      rgb(154, 148, 148, maxColorValue = 255),
      linetype = "dotted",
      rel(.5)),
    ...
    plot.background =    element_rect(colour = "gray96"),
    plot.title =         element_text( # font size "large"
      size = rel(1.2),
      hjust = 0, vjust = 1,
      margin = margin(b = half_line),
      color = rgb(19, 186, 243, maxColorValue = 255),
      face = "bold"
    ),
