#TO DO:
#reorder by finishing position at the end before saving
#driver input will come from racing reference/convert_indycar_pdfs script
#fix NAs and negative numbers that I use to manually fix
...
def raceStats(race_length, point_system="single"):
	...
	#TODO: reorder by finishing position
