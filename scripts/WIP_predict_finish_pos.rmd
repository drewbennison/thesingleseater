...
knitr::opts_knit$set(root.dir = 'C:/Users/kbennison/OneDrive - Nutrisystem, Inc/Personal/thesingleseater')
```
...
x <- model.matrix(fin ~ type + st + driver + PreviousEloRating + experience + owner + Engine + Rounds + n_races, df_clean)

y <- df_clean %>% select(fin) %>% as.matrix()
